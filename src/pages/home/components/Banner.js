  ...
  return (
    ...
    <div className="w-screen  max-w-7xl mx-auto flex flex-wrap">
        <div className="w-full pb-20 text-center lg:text-start px-4 lg:w-6/12">
            <h1 className=' text-4xl md:text-6xl text-sky-600 font-bold' >Find a Home you'll</h1>
            <h1 className='text-9xl py-3 parisienne-regular ' >Love</h1>
        </div>
        <div className="w-full px-4 lg:w-6/12">
            <div className="bg-gradient-to-r to-[#4492D3] from-[#07518F] mx-auto rounded-2xl w-11/12 p-5 md:py-20 md:px-14">
                   ...
                   <div className=' bg-white cursor-pointer  rounded-xl w-24 h-24 my-2 text-sm  justify-center items-center  flex flex-col' >
                    <img src={forBuyIcon} alt="" width="40px"  />
                   <p className='mt-3' > For Buy</p>
                    </div>
                    <div className=' bg-white cursor-pointer  rounded-xl w-24 h-24 my-2 text-sm  justify-center items-center  flex flex-col' >
                    <img src={forRentIcon} alt="" width="40px"  />
                   <p className='mt-3' > For Rent</p></div>
                    <div className=' bg-white cursor-pointer  rounded-xl w-24 h-24 my-2 text-sm  justify-center items-center flex flex-col' >
                    <img src={plotLandIcon} alt="" width="40px"  />
                   <p className='mt-3' >     Plots/ Land</p></div>
                    <div className=' bg-white cursor-pointer  rounded-xl w-24 h-24 my-2 text-sm  justify-center items-center flex flex-col' >
                    <img src={projectsIcon} alt="" width="40px"  />
                   <p className='mt-3' >     Projects</p></div>
                   </div>
                   <div>

                   </div>
                   <div className='mt-8 bg-white rounded-full p-4' >
                    All Res
                   </div>
                   <button className='bg-black text-white py-3 px-16 mt-12   rounded-full ' >Search</button>
            </div>
        </div>
